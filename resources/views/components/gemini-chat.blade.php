<!-- Self-contained Gemini Chat Component - v3 (Gradient Button) - Verified -->
<div>
        ...
        <div class="gemini-chat-header">
            <div class="gemini-chat-header-title">
                ...
                <div>
                    ...
                    <span>Connects to Google Gemini.</span>
                </div>
            </div>
...
<style>
    ...
    .ai-message { background-color: #eef1f5; color: #333; align-self: flex-start; border: 1px solid #e0e0e0; border-bottom-left-radius: 4px; }
    ...
    .gemini-send-button:hover { background-color: #0056b3; }
</style>
...
(function() {
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (!chatButton || !chatWindow) {
            console.error("Gemini Chat: Could not find essential chat elements.");
            return;
        }
        ...
        const sendMessage = async () => {
            ...
            try {
                ...
                appendMessage('ai', data.response || 'Sorry, I had trouble getting a response.');
            } catch (error) {
