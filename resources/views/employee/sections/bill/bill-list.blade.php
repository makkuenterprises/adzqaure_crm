    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="{{ route('employee.view.bill.list') }}">Payments & Bill</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div>
                        <a href="{{ route('employee.view.bill.create') }}" type="button"
                                            ...
                                            @foreach ($bills as $index => $bill)
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">
                                                        ...
                                                        <a href="{{ route('employee.view.bill.update', ['id' => $bill->id]) }}"
                                                        ...
                                                        <a href="{{ route('employee.bill.history', ['bill' => $bill->id]) }}" class="btn btn-info btn-sm content-icon view-remarks" title="View Payment History"><i class="fa fa-history"></i></a>
                                                        <a href="{{ route('employee.handle.bill.duplicate', ['id' => $bill->id]) }}"
                                                            class="btn btn-success btn-sm content-icon">
                                                            <i class="fa fa-window-maximize"></i>
                                                        </a>
                                                        <a href="{{ route('employee.handle.bill.invoice', ['id' => $bill->id]) }}"
