            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                       <h4 class="card-title">Bill #{{ $bill->id }} | Due: ₹{{ number_format($bill->total + $bill->tax - $bill->received_amount - $bill->discount_amount, 2) }}</h4>
                         ...
                         <div>
                            ...
                            @endif
                                <a href="{{ route('employee.view.bill.list') }}" class="btn btn-success btn-sm">Back</a>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="addPaymentModal" tabindex="-1" aria-labelledby="addPaymentModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{ route('employee.bill.history.store', $bill->id) }}">
                                    @csrf
                    ...
                    <div class="modal fade" id="settleBillModal" tabindex="-1" aria-labelledby="settleBillModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{ route('employee.bill.settle', $bill->id) }}">
                                    @csrf
                                    <div class="modal-header">
