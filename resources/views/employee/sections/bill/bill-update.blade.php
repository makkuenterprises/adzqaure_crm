...
@section('panel-header')
    <div>
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('employee.view.bill.list') }}">Billing</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('employee.view.bill.update', ['id' => $bill->id]) }}">Edit Bill</a></li>
        </ul>
    </div>
@endsection

@section('panel-body')
    <form action="{{ route('employee.handle.bill.update', ['id' => $bill->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
