    ...
    <div>
        ...
        <ul class="breadcrumb">
            ...
            @if (request('project_id'))
                ...
                <li><i data-feather="chevron-right"></i></li>
                <li><a href="{{ route('employee.view.project.preview', ['id' => request('project_id')]) }}">Manage Payments</a>
                </li>
                <li><i data-feather="chevron-right"></i></li>
            @else
            ...
            <li><a href="{{ route('employee.view.payment.create') }}">Add Payment</a></li>
        </ul>
    </div>
@endsection

@section('panel-body')
    <form action="{{ route('employee.handle.payment.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
