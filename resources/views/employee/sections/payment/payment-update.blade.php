...
@section('panel-header')
    <div>
        ...
        <ul class="breadcrumb">
            ...
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('employee.view.project.preview',['id' => request('project_id')]) }}">Manage Payments</a></li>
            <li><i data-feather="chevron-right"></i></li>
            @else
            ...
            <li><a href="{{ route('employee.view.payment.update',['id' => $payment->id]) }}">Edit Payment</a></li>
        </ul>
    </div>
@endsection

@section('panel-body')
    <form action="{{ route('employee.handle.payment.update', ['id' => $payment->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
