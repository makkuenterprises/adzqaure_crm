    ...
    <div class="content-body default-height">
        ...
        <div class="container-fluid">
            <div class="project-page d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="mb-4">
                    <a href="{{ route('employee.view.project.create') }}" class="btn btn-primary btn-rounded btn-loader">+ New Project</a>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                                                ...
                                                <div class="col-xl-3  col-md-4 col-sm-12 align-items-center customers">
                                                    <div class="media-body">
                                                        ...
                                                        <h6 class="text-black"><a class="text-black"
                                                                href="{{ route('employee.view.project.preview', ['id' => $project->id]) }}">{{ $project->name }}</a>
                                                        </h6>
                                                        ...
                                                        <div class="dropdown ms-4  mt-auto mb-auto">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('employee.view.project.update', ['id' => $project->id]) }}">Update</a>
                                                                {{-- <a class="dropdown-item"
                                                    ...
                                                    <div class="d-flex justify-content-sm-end project-btn">
                                                        ...
                                                        <div class="dropdown ms-4  mt-auto mb-auto">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('employee.project.change-status', ['id' => $project->id, 'status' => 'OnProgress']) }}">
                                                                    Mark as Progress
                                                                </a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="dropdown ms-4  mt-auto mb-auto">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="javascript:handleDelete({{ $project->id }});">Delete</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('employee.project.change-status', ['id' => $project->id, 'status' => 'Closed']) }}">
                                                                    Mark as Closed
                                                                </a>
                                                            </div>
                                                        </div>
    ...
    <script>
        function handleDelete(id) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = `{{ url('employee/group/delete') }}/${id}`;
                    }
                });
        }
    </script>
