...
@section('panel-header')
    <div>
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('employee.view.project.list') }}">Projects</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('employee.view.project.preview',['id' => $project->id]) }}">Manage Payments</a></li>
        </ul>
    </div>
@endsection
...
@section('panel-body')
        <figure class="panel-card">
            <div class="panel-card-header">
                ...
                <div class="space-x-3">
                    <a href="{{ route('employee.view.payment.create',['project_id' => $project->id]) }}&type=Credit" class="btn-primary-md">Add Credit</a>
                    <a href="{{ route('employee.view.payment.create',['project_id' => $project->id]) }}&type=Debit" class="btn-primary-md">Add Debit</a>
                </div>
            </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="table-dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <ul>
                                                    <li><a href="{{ route('employee.view.payment.update', ['id' => $payment->id]) }}?project_id={{$payment->project_id}}"
