        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('employee.view.project.create') }}">Create Project</a>
                    </li>
                </ol>
            </div>
            <!-- row -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('employee.handle.project.create') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="basic-form @error('customer_id') input-invalid @enderror">
                                            <select class="default-select form-control wide mb-3" name="customer_id">
                                                ...
                                                @foreach (DB::table('customers')->orderBy('name')->get() as $customer)
                                                    <option @selected(old('customer_id', request('customer_id')) == $customer->id) value="{{ $customer->id }}">
                                                        {{ $customer->name }}
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}"
                                                ...
                                                placeholder="Enter Project Name" minlength="1" maxlength="250">
                                            @error('name')
                                                <span class="input-error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="number" name="amount" value="{{ old('amount') }}"
                                                ...
                                                placeholder="Enter Amount" minlength="1" maxlength="250">
                                            @error('amount')
                                                <span class="input-error">{{ $message }}</span>
                                            @enderror
                                        </div>
