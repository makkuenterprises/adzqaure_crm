        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('employee.view.domain.hosting.list') }}">Domain &
                            Hosting</a></li>
                </ol>
            </div>
            <!-- Row -->
            <div class="row">
                <div class="col-xl-12">
                    <div>
                        <a href="{{ route('employee.view.domain.hosting.create') }}" type="button"
                                            ...
                                            @foreach ($domain_hostings as $index => $domain_hosting)
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">
                                                        ...
                                                        <a href="{{ route('employee.view.domain.hosting.update', ['id' => $domain_hosting->id]) }}"
                                                            class="btn btn-warning btn-sm content-icon">
                                                            <i class="fa fa-edit"></i>
                                                        </a>

                                                        <a href="{{ route('employee.handle.domain.hosting.bill.create', ['id' => $domain_hosting->id]) }}"
