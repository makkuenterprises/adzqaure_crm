            ...
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a
                            href="{{ route('employee.view.customer.update', ['id' => $customer->id]) }}">Update Customer</a>
                    </li>
                </ol>
            </div>
            <!-- row -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('employee.handle.customer.update', ['id' => $customer->id]) }}"
                                        ...
                                        <div class="col-xl-12 mb-3">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="profile-preview">
                                                    @if ($customer->profile)
                                                        <img src="{{ asset('employee/customers/' . $customer->profile) }}"
                                                            alt="Profile Image" class="img-thumbnail"
                                                            style="max-width: 100px; height: auto;">
                                                    @else
                                                        <img src="{{ asset('employee/customers/default-profile.png') }}"
