        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div>
                        <a href="{{ route('employee.view.customer.create') }}" type="button"
                                        ...
                                        <tbody>
                                            @foreach ($customers as $index => $customer)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="{{ route('employee.view.customer.preview', ['id' => $customer->id]) }}">{{ $customer->name }}</a>
                                                    </td>
                                                    ...
                                                    <td class="text-nowrap">
                                                        ...
                                                        <a href="{{ route('employee.view.customer.preview', ['id' => $customer->id]) }}"
                                                            class="btn btn-success btn-sm content-icon">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
