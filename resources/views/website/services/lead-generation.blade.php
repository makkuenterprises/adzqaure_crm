            ...
            <div class="container">
                ...
                <div class="cta-form">
                    ...
                    <form action="#" method="POST">
                        ...
                        <textarea name="message" rows="4" placeholder="Briefly describe your business and lead generation goals..."></textarea>
                        <button type="submit" class="cta-button">Build My Conversion Funnel</button>
                    </form>
                </div>
            </div>
        </section>
