                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{ route('admin.view.project.create', ['customer_id' => $customer->id]) }}" class="btn btn-primary btn-sm">+ Create New Project</a>
                                </div>
                                <div class="card-body">
                                    @forelse ($projects as $project)
                                        <div class="row align-items-center mb-4 border-bottom pb-3">
                                            <div class="col-xl-4 col-md-6 col-sm-12">
                                                ...
                                                <h6 class="text-black"><a class="text-black" href="{{ route('admin.view.project.preview', ['id' => $project->id]) }}">{{ $project->name }}</a></h6>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('admin.view.bill.create', ['customer_id' => $customer->id]) }}" class="btn btn-primary btn-sm">+ New Invoice</a>
                                </div>
                                <div class="card-body">
                                                ...
                                                @forelse ($bills as $bill)
                                                    <tr>
                                                        ...
                                                        <td class="text-end text-nowrap">
                                                            ...
                                                            <a href="{{ route('admin.handle.bill.invoice', ['id' => $bill->id]) }}" class="btn btn-info btn-xxs" title="Download">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('admin.view.domain.hosting.create', ['customer_id' => $customer->id]) }}" class="btn btn-primary btn-sm">+ Add New Record</a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-sm">
                                            ...
                                            <tbody>
                                                @forelse ($domainHostings as $domainHosting)
                                                    <tr>
                                                        ...
                                                        <td class="text-end text-nowrap">
                                                            <a href="{{ route('admin.view.domain.hosting.update', ['id' => $domainHosting->id]) }}" class="btn btn-warning btn-xxs" title="Edit">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        form.action = `{{ url('admin/project') }}/${id}`;
                        form.submit();
                    }
                });
        }
