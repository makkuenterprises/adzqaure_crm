...
@section('panel-header')
    <div>
        ...
        <ul class="breadcrumb">
            ...
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.customer.create') }}">Add Customer</a></li>
        </ul>
    </div>
@endsection

@section('panel-body')
    <form action="{{ route('admin.handle.customer.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <figure class="panel-card">
                ...
                <div class="grid md:grid-cols-4 sm:grid-cols-1 md:gap-7 sm:gap-5">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="city" value="{{ old('city') }}"
                            class="input-box-md @error('city') input-invalid @enderror" placeholder="Enter city"
                            minlength="1" maxlength="250">
                        @error('city')
                            <span class="input-error">{{ $message }}</span>
                        @enderror
            ...
            <div class="panel-card-footer">
                <button type="submit" class="btn-primary-md md:w-fit sm:w-full">Add Customer</button>
            </div>
        </figure>
    </form>
@endsection
