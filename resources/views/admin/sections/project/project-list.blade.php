            ...
            <div class="project-page d-flex justify-content-between align-items-center flex-wrap">
                <div class="card-tabs mb-4">
                    ...
                    <ul class="nav nav-tabs style-1" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request('status') == 'OnProgess' ? 'active' : '' }}" data-bs-toggle="tab"
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tab-content">
                                                ...
                                                <div class="col-xl-2  col-sm-6 col-sm-4 mt-xl-0  mt-3">
                                                    <div class="d-flex justify-content-sm-end project-btn">
                                                        <a href="javascript:void(0);" class="badge badge-md light"
                                                            style="
                                                            @if ($project->status == 'OnProgess') background-color: #d7fde2; color: #09BD3C;
                        ...
                        <!-- On Progress Tab -->
                        <div class="tab-pane fade {{ request('status') == 'OnProgess' ? 'active show' : '' }}"
                            id="OnProgress">
