        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.view.project.update', ['id' => $project->id]) }}">Update Project</a>
                    </li>
                </ol>
            </div>
            <!-- row -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('admin.handle.project.update', ['id' => $project->id]) }}" method="POST"
