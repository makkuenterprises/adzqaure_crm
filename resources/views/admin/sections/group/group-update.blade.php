            ...
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a
                            href="{{ route('admin.view.group.update', ['id' => $group->id]) }}">Update Data Groups</a></li>
                </ol>
            </div>
            <!-- Row -->
            <div class="row">
                <div class="col-xl-12">
                    <form action="{{ route('admin.handle.group.update', ['id' => $group->id]) }}" method="POST"
                        ...
                        <div class="filter cm-content-box box-primary">
                            ...
                            <div class="mb-3 m-3 col-md-6">
                                <label for="name" class="form-label">Update Group Name<span
