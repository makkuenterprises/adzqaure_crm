            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="{{ route('admin.view.lead.manager.create') }}">Create Lead</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{ route('admin.handle.lead.manager.create') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
