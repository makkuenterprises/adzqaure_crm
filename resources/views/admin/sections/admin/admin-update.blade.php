            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="{{ route('admin.view.admin.update', ['id' => $admin->id]) }}">Update Admin</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                                    ...
                                    <form action="{{ route('admin.handle.admin.update', ['id' => $admin->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" name="name" value="{{ old('name', $admin->name) }}" class="form-control @error('name') input-invalid @enderror" placeholder="Enter name" minlength="1" maxlength="250">
                                                @error('name')
                                                    <span class="input-error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" name="email" value="{{ old('email', $admin->email) }}" class="form-control @error('email') input-invalid @enderror" placeholder="Enter email" minlength="1" maxlength="250">
                                                @error('email')
                                                    <span class="input-error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3 col-md-6 position-relative">
                                                <label class="form-label" for="dlab-password">New Password<span class="text-danger">*</span></label>
                                            ...
                                            <div class="mb-3 col-md-6 position-relative">
                                                <label class="form-label" for="dlab-password">Confirm Password<span class="text-danger">*</span></label>
                                                <input type="password" name="password_confirmation" id="dlab-password"
                                                    ...
                                                    placeholder="Enter confirm password" required minlength="6" maxlength="20">
