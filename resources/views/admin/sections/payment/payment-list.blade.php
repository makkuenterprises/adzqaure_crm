...
@section('panel-body')
    <figure class="panel-card">
        <div class="panel-card-header">
            ...
            <div class="space-x-3">
                <a href="{{ route('admin.view.payment.create') }}?type=Credit" class="btn-primary-md">Add Credit</a>
                <a href="{{ route('admin.view.payment.create') }}?type=Debit" class="btn-primary-md">Add Debit</a>
            </div>
        </div>
                                ...
                                <td>
                                    ...
                                    <div class="table-dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul>
                                                <li><a href="{{ route('admin.view.payment.update', ['id' => $payment->id]) }}"
