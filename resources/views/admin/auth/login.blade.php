...
@section('auth-card')
    ...
    <figure class="rounded-lg shadow-lg bg-white">
        <form action="{{route('admin.handle.login')}}" method="POST" class="p-10 text-center space-y-6" onsubmit="this.querySelector('button[type=submit]').setAttribute('disabled','disabled')">
